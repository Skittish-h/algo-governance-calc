    ...
    <div>
      ...
      <div className="App-section App-container">
        <div className="App-half App-half-left App-center">
          <StatisticDiv heading="Your Governance ALGO reward" value= {props.loaded ? calculateReward(field, props.data.total_committed_stake/1000000, parseInt(props.data.algo_amount_in_reward_pool)/1000000) : "..loading"}/>
        </div>
        ...
        <div className="App-half App-half-left App-center">
          <StatisticDiv heading="Period #1 Governance APY%" value= {props.loaded ? calculateNonCAPY(props.data.start_datetime, props.data.end_datetime , props.data.total_committed_stake/1000000, parseInt(props.data.algo_amount_in_reward_pool)/1000000) : "..loading"}/>
        </div>
        <div className="App-half App-center">
